...
//   return (
//     <div className="w-full rounded-lg shadow-lg border border-gray-200 bg-white overflow-hidden">
...
//                   <td className="px-6 py-3 text-gray-700 break-words max-w-[200px]">{u.name}</td>

//                   {/* Email - cho phép xuống dòng */}
//                   <td className="px-6 py-3 text-gray-600 break-all max-w-[250px]">{u.email}</td>

//                   {/* SĐT - thường ngắn, vẫn có thể nowrap */}
